...
Takes user inputs to determine tail angles of galaxy images based on supplied RA and Dec cordinates.
...
JF_table = pd.read_csv('Tuts_JF_high_testset.csv') # Load in table
